...
contextBridge.exposeInMainWorld('chatAggregator', {
  ...
  localChatGoogleStatus: () => ipcRenderer.invoke('local-chat:google-status'),
  localChatGoogleStart: (payload) => ipcRenderer.invoke('local-chat:google-start', payload),
  localChatGoogleComplete: (payload) => ipcRenderer.invoke('local-chat:google-complete', payload),
